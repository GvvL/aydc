...
public class StoreHouseHeader extends View implements PtrUIHandler {
    ...
    private int mDropHeight = -1;//拉伸到刷新的距离
    ...
    private void initView() {
        mLineWidth = AppUtil.dp2px(1);
        mDropHeight = AppUtil.dp2px(40);
        mHorizontalRandomness = AppUtil.dp2px(AppUtil.getSceenDp()[1])/ 2;
    }
    ...
    private int getTopOffset() {
        return getPaddingTop() + AppUtil.dp2px(10);
    }

    private int getBottomOffset() {
        return getPaddingBottom() + AppUtil.dp2px(10);
    }
    ...
    public void initWithPointList(ArrayList<float[]> pointList) {
        ...
        for (int i = 0; i < pointList.size(); i++) {
            ...
            PointF startPoint = new PointF(AppUtil.dp2px(line[0]) * mScale, AppUtil.dp2px(line[1]) * mScale);
            PointF endPoint = new PointF(AppUtil.dp2px(line[2]) * mScale, AppUtil.dp2px(line[3]) * mScale);
	...
	public float getmBarDarkAlpha() {
		return mBarDarkAlpha;
	}

	public void setmBarDarkAlpha(float mBarDarkAlpha) {
		this.mBarDarkAlpha = mBarDarkAlpha;
	}
}