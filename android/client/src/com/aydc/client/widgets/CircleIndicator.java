...
import com.aydc.client.widgets.MImageCycleView.ImageCycleViewPager;
...
public class CircleIndicator extends LinearLayout {
    ...
    public void setViewPager(ImageCycleViewPager viewPager) {
    ...
    private final OnPageChangeListener mInternalPageChangeListener = new OnPageChangeListener() {
        ...
        @Override public void onPageSelected(int position) {
            ...
            if (mViewpager.getAdapter() == null || mViewpager.realCount <= 0) {
                return;
            }
            ...
            if (mLastPosition >= 0) {
                View currentIndicator = getChildAt(mLastPosition%mViewpager.realCount);
                currentIndicator.setBackgroundResource(mIndicatorUnselectedBackgroundResId);
                mAnimatorIn.setTarget(currentIndicator);
                mAnimatorIn.start();
            }

            View selectedIndicator = getChildAt(position%mViewpager.realCount);
    ...
    private DataSetObserver mInternalDataSetObserver = new DataSetObserver() {
        @Override public void onChanged() {
            ...
            int newCount = mViewpager.realCount;
    ...
    private void createIndicators() {
        removeAllViews();
        int count = mViewpager.realCount;
        if (count <= 0) {
            return;
        }
